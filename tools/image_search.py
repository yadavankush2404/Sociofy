...
#             raise RuntimeError("UNSPLASH_ACCESS_KEY not set. Add it to your .env")
...
#             if hits:
#             # Prefer mid-resolution, random pick for variety
#                 return random.choice(hits[: min(8, len(hits))])
#     return None
